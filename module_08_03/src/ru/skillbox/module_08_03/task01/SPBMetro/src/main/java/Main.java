...
public class Main
{
    ...
    private static String dataFile = "/Users/administrator/Desktop/Java/Skillbox-git/module_08_03/src/ru/skillbox/module_08_03/task01/SPBMetro/src/main/resources/map.json";
    ...
    public static void main(String[] args)
    {
        ...
        for(;;)
        {
            try {
                ...
                LOGGER.info(INPUT_HISTORY_MARKER,"Пользователь ввел станции от {} до {}", from,to);
